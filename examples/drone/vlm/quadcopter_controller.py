...
class DronePIDController:
    ...
    def set_pid_params(self, pid_params):
        self.__init__(self.drone, self.__dt, self.__base_rpm, pid_params)

    def get_pid_params(self):
        return [
            [self.__pid_pos_x.kp, self.__pid_pos_x.ki, self.__pid_pos_x.kd],
            [self.__pid_pos_y.kp, self.__pid_pos_y.ki, self.__pid_pos_y.kd],
            [self.__pid_pos_z.kp, self.__pid_pos_z.ki, self.__pid_pos_z.kd],
            [self.__pid_vel_x.kp, self.__pid_vel_x.ki, self.__pid_vel_x.kd],
            [self.__pid_vel_y.kp, self.__pid_vel_y.ki, self.__pid_vel_y.kd],
            [self.__pid_vel_z.kp, self.__pid_vel_z.ki, self.__pid_vel_z.kd],
            [self.__pid_att_roll.kp, self.__pid_att_roll.ki, self.__pid_att_roll.kd],
            [self.__pid_att_pitch.kp, self.__pid_att_pitch.ki, self.__pid_att_pitch.kd],
            [self.__pid_att_yaw.kp, self.__pid_att_yaw.ki, self.__pid_att_yaw.kd],
        ]
    ...
    def __get_drone_att(self) -> torch.Tensor:
        ...
        return quat_to_xyz(quat, rpy=True, degrees=True) # (roll, pitch, yaw)

    def __mixer(self, thrust, roll, pitch, yaw, x_vel, y_vel) -> torch.Tensor:
        
        # Control signals for individual motor RPMs
    ...
    def update(self, target) -> np.ndarray:
        ...
        # Get control signals for velocity and thrust input
        ...
        # Get control signales for row, pitch and yaw
